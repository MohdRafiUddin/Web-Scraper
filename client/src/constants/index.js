// Actions
export const GET_V1_CURRENT_USER = "api/v1/current_user";
export const GET_V1_CURRENT_USER_DATA = "api/v1/current_user/data";
export const CREATE_V1_MEDIA_SCRAPER = "api/v1/media-scraper";

// Components
export const DASHBOARD_HEADER_CONTENT = "Web Scraper Media Gallery";
export const DASHBOARD_HEADER_CONTENT_TEXT =
...
// Ids
export const SEARCH_INPUT_FIELD_ID = "filter-images-list-id";

// Placeholders
export const IMAGE_CONTENT_SEARCH_FIELD = "Type media name to search...";
export const SEARCH_BAR_INPUT_FIELD =
...
export const IMAGE_THUMBNAIL_CLASSNAME = "col-lg-4 col-sm-6";
export const THUMBNAIL_CLASSNAME = "thumbnail";
export const FORM_CONTROL_CLASSNAME = "form-control";
export const INPUT_GROUP_CLASSNAME = "input-group";
export const INPUT_GROUP_BTN_CLASSNAME = "input-group-btn";
export const BTN_BTN_SECONDARY_CLASSNAME = "btn btn-secondary";
